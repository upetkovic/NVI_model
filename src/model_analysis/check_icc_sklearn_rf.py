...
model_dir = "data/sklearn_saved_models"
model_dir = "data/sklearn_saved_models_merged"
model_dir = "data/sklearn_saved_models_emotions_normalized"
model_dir = "data/sklearn_saved_models_emotions_normalized_NEW"
model_dir = "data/sklearn_saved_models_emotions_normalized_no_real_changes"
...
model_paths.sort()
model_paths = ["./data/sklearn_saved_models_emotions_rf_gridsearch_2/rf_grid_model_r_0p396046.joblib"]
for path in model_paths:
    model = load(path)
    preds = model.predict(X_val)
    
    corr, p = pearsonr(y_val, preds)
    print(f"corr, p: {corr}, {p}")
    if corr > 0.1:
