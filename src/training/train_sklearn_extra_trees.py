...
save_dir = "./data/sklearn_saved_models_emotions_extratrees_grid"
...
# ----- Save model -----
model_path = os.path.join(save_dir, f"extratrees_grid_r_{r_val:.6f}".replace(".", "p") + ".joblib")
dump(best_model, model_path)
print(f"✅ Saved best Extra Trees model to: {model_path}")
