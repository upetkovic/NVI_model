...
class Detector:
    def __init__(self, device):
        config_file = "external/GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py"
        grounding_dino_ckpt = 'external/segment_and_track_anything/ckpt/groundingdino_swint_ogc.pth'
